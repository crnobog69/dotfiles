...
WATCH_DIR="/run/media/lain/VERMAHT/Linux/НАЦИЗАМ/"
USERNAME="lain"
SCRIPT_NAME="filen-sync-nacizam.sh"
SERVICE_NAME="filen-sync-nacizam.service"
...
sudo cp filen-sync-nacizam.timer /etc/systemd/system
